...
use Swow\Channel;
use Swow\Coroutine;
use Swow\Debug\DebuggerException;
use Swow\Signal;
use Swow\Socket;
...
TEXT;
    ...
    public function out(string $string = '', bool $newline = true, string $color = 'blue'): static
    {
    ...
    {
        return $this->out($this::tableFormat($table), $newline, 'lightGreen');
    }
